    ...
    private void downloadFile(ActionEvent event) {
        ...
        if (selectedDirectory != null) {
            ...
            try {
                ...
                new AlertPopUpGenerator().showCustomMessage(Alert.AlertType.INFORMATION, "Operación exitosa",
                        "Se ha descargado el archivo correctamente.");
            } catch (IOException exception) {
                new AlertPopUpGenerator().showCustomMessage(Alert.AlertType.ERROR, "Ocurrió un error",
                        "No se pudo descargar el archivo. Por favor intente de nuevo más tarde.");
            }
        }
    }

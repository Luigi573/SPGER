...
public interface IResearchesReportDAO {
    ...
    public abstract ArrayList<ResearchProject> getValidatedAndNotValidatedResearches(String title)
            throws DataRetrievalException;

    public abstract ArrayList<ResearchProject> getSelectedResearches(ArrayList<String> selectedResearchesTitles)
            throws DataRetrievalException;
}

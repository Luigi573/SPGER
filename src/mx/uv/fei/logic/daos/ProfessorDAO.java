...
public class ProfessorDAO implements IProfessorDAO{
    ...
    public void modifyProfessorDataFromDatabase(Professor newProfessorData, Professor originalProfessorData) throws DataWritingException {
        try {
            newProfessorData.setUserId(this.getIdUserFromProfessor(originalProfessorData));
    ...
    public ArrayList<Professor> getProfessorsFromDatabase() throws DataRetrievalException{
        ...
        try{
            ...
            while(resultSet.next()) {
                ...
                professor.setStaffNumber(Integer.parseInt(resultSet.getString("NumPersonal")));
    ...
    private int getIdUserFromProfessor(Professor originalProfessorData) throws DataRetrievalException{
        int idUser = 0;
